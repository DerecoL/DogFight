...
CREATE INDEX "CurrencyLedger_userId_dailyDate_idx" ON "CurrencyLedger"("userId", "dailyDate");
CREATE UNIQUE INDEX "AchievementProgress_userId_achievementId_key" ON "AchievementProgress"("userId", "achievementId");
CREATE INDEX "AchievementProgress_userId_completedAt_idx" ON "AchievementProgress"("userId", "completedAt");
