...
describe('equipment layout scale', () => {
  ...
  it('uses stronger quality glow on shop paper edges without replacing the brown edge', () => {
    expect(cssRule('.paper-shop-card.quality-bronze')).toContain('--shop-quality-glow: rgba(190, 111, 50, .56)')
    expect(cssRule('.paper-shop-card.quality-silver')).toContain('--shop-quality-glow: rgba(207, 224, 236, .66)')
    expect(cssRule('.paper-shop-card.quality-gold')).toContain('--shop-quality-glow: rgba(255, 207, 66, .95)')
    expect(cssRule('.paper-shop-card.quality-diamond')).toContain('--shop-quality-glow: rgba(102, 231, 255, .96)')
  ...
  it('adds tone-driven item card art windows with readable text bands', () => {
    ...
    expect(cssRule('.shop-card-art .item-card-icon-art')).toContain('width: min(76%, 84px)')
