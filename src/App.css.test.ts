...
describe('equipment layout scale', () => {
  ...
  it('keeps battle equipment card copy bounded while preserving full details for inspection', () => {
    expect(app).toContain('const battleNameScale')
    expect(app).toContain('className="battle-item-name"')
    expect(app).toContain('style={{')
    expect(app).toContain("'--battle-name-scale': battleNameScale")
    ...
    expect(cssRule('.battle-item-name')).toContain('font-size: calc(13px * var(--battle-name-scale, 1))')
