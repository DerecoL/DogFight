...
describe('equipment layout scale', () => {
  ...
  it('keeps the center dice as a three-dimensional handdrawn die after shared UI styles load', () => {
    ...
    expect(lastUiCssRule('.battle-dice.dynamic-dice .dynamic-dice-cube')).toContain('transform: rotate(-7deg)')
    ...
    expect(lastUiCssRule('.battle-dice.dynamic-dice .dynamic-dice-face.top')).toContain('height: var(--dice-depth)')
    expect(lastUiCssRule('.battle-dice.dynamic-dice .dynamic-dice-face.top')).toContain('transform: skewX(32deg)')
    expect(lastUiCssRule('.battle-dice.dynamic-dice .dynamic-dice-face.side')).toContain('width: var(--dice-depth)')
    expect(lastUiCssRule('.battle-dice.dynamic-dice .dynamic-dice-face.side')).toContain('transform: skewY(32deg)')
    expect(lastUiCssRule('.battle-dice.dynamic-dice .dynamic-dice-face.top .dynamic-dice-pips, .battle-dice.dynamic-dice .dynamic-dice-face.side .dynamic-dice-pips')).toContain('display: none')
  ...
  it('keeps the animated battle dice cube and only puts roll results in the center burst', () => {
    ...
    expect(cssRule('.battle-dice.dynamic-dice .dynamic-dice-cube')).toContain('transform: rotate(-7deg)')
  ...
  it('renders the center battle dice as a solid die with visible thickness instead of a backing card', () => {
    ...
    expect(cssRule('.dynamic-dice-face.top')).toContain('height: var(--dice-depth)')
    expect(cssRule('.dynamic-dice-face.top')).toContain('transform: skewX(32deg)')
    expect(cssRule('.dynamic-dice-face.side')).toContain('width: var(--dice-depth)')
    expect(cssRule('.dynamic-dice-face.side')).toContain('transform: skewY(32deg)')
    expect(cssRule('.dynamic-dice-pips i')).toContain('opacity: 0')
    expect(css).toContain('42% { transform: rotate(11deg) translateY(-18px) scale(1.26); }')
