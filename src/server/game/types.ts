...
export type Phase = 'MAP' | 'SHOP' | 'CHOICE' | 'CLASS_REWARD' | 'ENCHANT_CHOICE' | 'RELIC_CHOICE' | 'UPGRADE_CHOICE' | 'POTION_CHOICE' | 'PREP' | 'MATCH' | 'BATTLE' | 'COMPLETE'
export type ShopType = 'GENERAL' | 'LARGE' | 'MEDIUM' | 'SMALL' | 'SMALL_DICE' | 'BIG_DICE' | 'RELIC' | 'UPGRADE' | 'UPGRADE_SILVER' | 'UPGRADE_GOLD' | 'UPGRADE_DIAMOND' | 'POTION'
...
export type AdvancedEffect =
  ...
  | 'MULTI_REPEAT_BONUS'
  | 'SMALL_TRIGGER_COUNTER'
  | 'POISON_TO_HEAL'
  | 'SHIELD_TO_DAMAGE'
  | 'ANTI_FREQUENCY_DISABLE_SMALL'
  | 'ANTI_MULTI_SUPPRESS'
  | 'CLEANSE_POISON_TO_SHIELD'
  | 'BREAK_SHIELD_THORNS'
