...
export const BUILD_COMPONENTS: BuildComponent[] = [
  ...
  component('SMALL_DICE', 'PAYOFF', 'ITEM', 'v5-shattered-tooth-gear', '1 格装备触发次数转直接伤害。'),
  ...
  component('MULTI', 'COUNTER', 'ITEM', 'v5-barkproof-earmuffs', '连续触发阈值后失效小型装备。'),
  component('MULTI', 'COUNTER', 'ITEM', 'v5-offbeat-metronome', '压低敌方多重额外触发次数。'),
  ...
  component('POISON', 'DEFENSE', 'ITEM', 'v5-poison-blood-pump', '敌方中毒层数转化为己方治疗。'),
  component('POISON', 'COUNTER', 'ITEM', 'v3-dog-catnip', '自身负面净化。'),
  component('POISON', 'COUNTER', 'ITEM', 'v5-bitter-kibble', '中毒净化转护盾。'),
  ...
  component('SHIELD_THORNS', 'PAYOFF', 'ITEM', 'v5-biteback-shield', '当前护盾转直接伤害。'),
  component('SHIELD_THORNS', 'DEFENSE', 'ITEM', 'v3-wooden-shield', '稳定护盾来源。'),
  component('SHIELD_THORNS', 'DEFENSE', 'ITEM', 'v5-bitter-kibble', '反毒时获得护盾。'),
  component('SHIELD_THORNS', 'COUNTER', 'ITEM', 'v4-reverse-fur-comb', '清除敌方正面层数。'),
  component('SHIELD_THORNS', 'COUNTER', 'ITEM', 'v5-thornbreaker-chew', '清除荆棘并强化破盾。'),
  ...
  component('BOOM_FREQUENCY', 'PAYOFF', 'ITEM', 'v5-shattered-tooth-gear', '小型装备触发次数转直接伤害。'),
  ...
  component('BOOM_FREQUENCY', 'COUNTER', 'ITEM', 'v5-barkproof-earmuffs', '连续触发阈值后打断小型高频装备。'),
