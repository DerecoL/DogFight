...
export const ITEM_DEFS: ItemDef[] = [
  ...
  slotItem('lucky-paw', '幸运爪垫', 1, 4, [6], ['big', 'multi'], { type: 'DAMAGE', amount: 5 }, {
    multi: 2,
    description: '造成 5 点伤害。【多重 2】：命中时总共完整触发 2 次。',
  }),
  slotItem('milk-bone', '牛奶骨头', 1, 4, [2, 4], ['heal', 'multi'], { type: 'HEAL', amount: 3 }, {
    multi: 2,
    description: '恢复 3 点生命值。【多重 2】：命中时总共完整触发 2 次。',
  }),
  slotItem('rubber-ball', '橡胶球', 2, 6, [3, 5], ['medium', 'multi'], { type: 'DAMAGE', amount: 4 }, {
    multi: 2,
    description: '造成 4 点伤害。【多重 2】：命中时总共完整触发 2 次。',
  }),
  slotItem('spiked-collar', '尖刺项圈', 2, 7, [4, 5, 6], ['big', 'medium'], { type: 'DAMAGE', amount: 8 }),
  slotItem('training-disc', '训练飞盘', 2, 6, [1, 6], ['medium', 'multi'], { type: 'DAMAGE', amount: 3 }, {
    multi: 3,
    description: '造成 3 点伤害。【多重 3】：命中时总共完整触发 3 次。',
  }),
